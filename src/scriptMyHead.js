...
const ambientLight = new THREE.AmbientLight(debugObject.ambientColor, 1.87);
...
const directionalLight = new THREE.DirectionalLight(
  debugObject.directionalColor,
  1
);
directionalLight.position.set(5, -5, 4.3);
...
lightFolder
  .addColor(debugObject, "directionalColor")
...
debugObject.pointLightColor = "#2338d1"; // Format hex valide
...
debugObject.rectAreaLightColor = "#0099e6";
...
rectAreaLight.position.set(-1, -1.7, 1);
...
// redMaterial.transmission = 0.5
rectAreaLightPositionFolder
  .add(redMaterial, "roughness")
  .min(0)
  .max(1)
  .step(0.01);
rectAreaLightPositionFolder
  .add(redMaterial, "metalness")
  .min(0)
  .max(1)
  .step(0.01);
rectAreaLightPositionFolder
  .add(redMaterial, "clearcoat")
  .min(0)
  .max(1)
  .step(0.01);
rectAreaLightPositionFolder
  .add(redMaterial, "reflectivity")
  .min(0)
  .max(1)
  .step(0.01);
...
gltfLoader.load("/models/face.glb", (gltf) => {
  console.log(gltf);
