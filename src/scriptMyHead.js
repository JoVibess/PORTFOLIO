...
// Ambient Light
debugObject.ambientColor = '#f7f1ab' // Correction: Format valide pour dat.GUI
const ambientLight = new THREE.AmbientLight(debugObject.ambientColor, 0.227)
...
// Directional Light
debugObject.directionalColor = '#ffffff' // Correction: Format valide pour dat.GUI
const directionalLight = new THREE.DirectionalLight(debugObject.directionalColor, 1)
directionalLight.position.set(-0.85, 2.6, 1.56)
